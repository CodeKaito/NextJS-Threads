...
var ThreadCard = function (_a) {
    ...
    return;
    React.createElement("article", { className: "flex w-full flex-col rounded-xl bg-dark-2 p-7" },
                ...
                React.createElement("div", { className: "flex w-full flex-col" },
                    ...
                    React.createElement("div", { className: "mt-5 flex flex-col gap-3" },
                        React.createElement("div", { className: "flex gap-3.5" },
                            ...
                            React.createElement(image_1["default"], { src: "/assets/post.svg", alt: "post", width: 24, height: 24, className: "cursor-pointer object-contain" }),
